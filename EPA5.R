...
# 
# 
# save(df5, file = "Datos/df5.Rdata")
load("Datos/df5.Rdata")
...
twowayfeweights(df5, "employedr", "indiv", "time", "tra", type = "feTR", summary_measures = T)
twowayfeweights(df5, "employedsum", "indiv", "time", "tra", type = "feTR", summary_measures = T)
twowayfeweights(df5, "ewdr", "indiv", "time", "tra", type = "feTR", summary_measures = T)
twowayfeweights(df5, "ewdsum", "indiv", "time", "tra", type = "feTR", summary_measures = T)
...
gewdr<-iplot(mod_ewdr)
gewdr<-iplot(mod_ewdsum)


linearHypothesis(mod_employedsum, c("timeto::-7:da=0", 
                                 "timeto::-6:da=0", 
                                 "timeto::-5:da=0", 
                                 "timeto::-4:da=0", 
                                 "timeto::-3:da=0", 
...
twowayfeweights(df5, "rate", "indiv", "time", "tra", type = "feTR", summary_measures = T)
twowayfeweights(df5, "ratesum", "indiv", "time", "tra", type = "feTR", summary_measures = T)
...
twowayfeweights(df5, "temprate", "indiv", "time", "tra", type = "feTR", summary_measures = T)
...
twowayfeweights(df5, "permrate", "indiv", "time", "tra", type = "feTR", summary_measures = T)
...
twowayfeweights(df5, "openendr", "indiv", "time", "tra", type = "feTR", summary_measures = T)
twowayfeweights(df5, "openendsum", "indiv", "time", "tra", type = "feTR", summary_measures = T)
...
linearHypothesis(mod_openendsum, c("timeto::-7:da=0", 
                                 "timeto::-6:da=0", 
                                 "timeto::-5:da=0", 
                                 "timeto::-4:da=0", 
                                 "timeto::-3:da=0", 
...
twowayfeweights(df5, "jcompleta", "indiv", "time", "tra", type = "feTR", summary_measures = T)
twowayfeweights(df5, "jcompletasum", "indiv", "time", "tra", type = "feTR", summary_measures = T)
...
twowayfeweights(df5, "htrab", "indiv", "time", "tra", type = "feTR", summary_measures = T)
twowayfeweights(df5, "hcontrato", "indiv", "time", "tra", type = "feTR", summary_measures = T)
...
linearHypothesis(mod_hourscontr, c("timeto::-7:da=0", 
                              "timeto::-6:da=0", 
                              "timeto::-5:da=0", 
                              "timeto::-4:da=0", 
                              "timeto::-3:da=0", 
...
twowayfeweights(df5, "otro", "indiv", "time", "tra", type = "feTR", summary_measures = T)
twowayfeweights(df5, "otrosum", "indiv", "time", "tra", type = "feTR", summary_measures = T)
...
twowayfeweights(df5, "employedr", "indiv", "time", "trb", type = "feTR", summary_measures = T)
twowayfeweights(df5, "employedsum", "indiv", "time", "trb", type = "feTR", summary_measures = T)
twowayfeweights(df5, "ewdr", "indiv", "time", "trb", type = "feTR", summary_measures = T)
twowayfeweights(df5, "ewdsum", "indiv", "time", "trb", type = "feTR", summary_measures = T)
...
mod_employedsum = feols(employedsum ~ i(timeto, db, ref = +0) + rate + jcompleta + htrab+otro+ edad+male+ncony+educsup|                    ## Other controls
                        ...
                        cluster = ~indiv,                          ## Clustered SEs
                        data = df5)
mod_ewdr = feols(ewdr ~ i(timeto, db, ref = +0) + rate + jcompleta + htrab+otro+ edad+male+ncony+educsup|                    ## Other controls
                   indiv+ yearq,                             ## FEs
                 cluster = ~indiv,                          ## Clustered SEs
                 data = df5)
mod_ewdsum = feols(ewdsum ~ i(timeto, db, ref = +0) + rate + jcompleta + htrab+otro+ edad+male+ncony+educsup|                    ## Other controls
                     indiv+ yearq,                             ## FEs
                   cluster = ~indiv,                          ## Clustered SEs
                   data = df5)
...
linearHypothesis(mod_employedsum, c("timeto::-7:db=0", 
                                    "timeto::-6:db=0", 
                                    "timeto::-5:db=0", 
                                    "timeto::-4:db=0", 
                                    "timeto::-3:db=0", 
...
twowayfeweights(df5, "rate", "indiv", "time", "trb", type = "feTR", summary_measures = T)
twowayfeweights(df5, "ratesum", "indiv", "time", "trb", type = "feTR", summary_measures = T)
...
twowayfeweights(df5, "temprate", "indiv", "time", "trb", type = "feTR", summary_measures = T)
...
twowayfeweights(df5, "permrate", "indiv", "time", "trb", type = "feTR", summary_measures = T)
...
twowayfeweights(df5, "openendr", "indiv", "time", "trb", type = "feTR", summary_measures = T)
twowayfeweights(df5, "openendsum", "indiv", "time", "trb", type = "feTR", summary_measures = T)
...
linearHypothesis(mod_openendsum, c("timeto::-7:db=0", 
                                   "timeto::-6:db=0", 
                                   "timeto::-5:db=0", 
                                   "timeto::-4:db=0", 
                                   "timeto::-3:db=0", 
...
twowayfeweights(df5, "jcompleta", "indiv", "time", "trb", type = "feTR", summary_measures = T)
twowayfeweights(df5, "jcompletasum", "indiv", "time", "trb", type = "feTR", summary_measures = T)
...
twowayfeweights(df5, "htrab", "indiv", "time", "trb", type = "feTR", summary_measures = T)
twowayfeweights(df5, "hcontrato", "indiv", "time", "trb", type = "feTR", summary_measures = T)
...
linearHypothesis(mod_hourscontr, c("timeto::-7:db=0", 
                                   "timeto::-6:db=0", 
                                   "timeto::-5:db=0", 
                                   "timeto::-4:db=0", 
                                   "timeto::-3:db=0", 
...
twowayfeweights(df5, "otro", "indiv", "time", "trb", type = "feTR", summary_measures = T)
twowayfeweights(df5, "otrosum", "indiv", "time", "trb", type = "feTR", summary_measures = T)
...
#Employment
out1 <- gsynth(employedsum ~ trb + rate+ jcompleta + educsup, data = df5, 
...
out2 <- gsynth(ewdsum ~ trb +employedr+ rate+ jcompleta + educsup, data = df5, 
               index = c("indiv","time"), force = "two-way", 
               CV = TRUE, se = TRUE, 
               inference = "parametric", nboots = 1000, 
               parallel = FALSE)
...
out3 <- gsynth(rate ~ trb +employedr+ jcompleta + educsup, data = df5, 
               index = c("indiv","time"), force = "two-way", 
               CV = TRUE, se = TRUE, 
               inference = "parametric", nboots = 1000, 
               parallel = FALSE)
...
out4 <- gsynth(temprate ~ trb +employedr+ jcompleta + educsup, data = df5, 
               index = c("indiv","time"), force = "two-way", 
               CV = TRUE, se = TRUE, 
               inference = "parametric", nboots = 1000, 
               parallel = FALSE)
...
out5 <- gsynth(permrate ~ trb +employedr+ jcompleta + educsup, data = df5, 
               index = c("indiv","time"), force = "two-way", 
               CV = TRUE, se = TRUE, 
               inference = "parametric", nboots = 1000, 
               parallel = FALSE)
...
out6 <- gsynth(openendr ~ trb +employedr+ jcompleta + educsup, data = df5, 
               index = c("indiv","time"), force = "two-way", 
               CV = TRUE, se = TRUE, 
               inference = "parametric", nboots = 1000, 
               parallel = FALSE)
...
out7 <- gsynth(jcompletasum ~ trb +employedr+rate+ educsup, data = df5, 
               index = c("indiv","time"), force = "two-way", 
               CV = TRUE, se = TRUE, 
               inference = "parametric", nboots = 1000, 
               parallel = FALSE)
...
out8 <- gsynth(htrab ~ trb +employedr+ jcompleta+ rate+ educsup, data = df5, 
               index = c("indiv","time"), force = "two-way", 
               CV = TRUE, se = TRUE, 
               inference = "parametric", nboots = 1000, 
               parallel = FALSE)
...
out8 <- gsynth(hcontrato ~ trb +employedr+ jcompleta+ rate+ educsup, data = df5, 
               index = c("indiv","time"), force = "two-way", 
               CV = TRUE, se = TRUE, 
               inference = "parametric", nboots = 1000, 
               parallel = FALSE)
...
out9 <- gsynth(otrosum ~ trb +employedr+ jcompleta+ rate+ educsup, data = df5, 
               index = c("indiv","time"), force = "two-way", 
               CV = TRUE, se = TRUE, 
               inference = "parametric", nboots = 1000, 
               parallel = FALSE)
